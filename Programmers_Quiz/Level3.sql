...
정답
-- 코드를 입력하세요
-- 대여 시작일 기준 2022년 8월 ~ 2022년 10월까지 총 대여 횟수 5회 이상
-- 해당 기간 동안의 월별 자동차 ID 별 총 대여 횟수
-- 월을 기준으로 오름차순 정렬, 월이 같다면 자동차 ID 기준 내림차순
-- 특정 월의 총 대여횟수 0이면 결과에서 제외
SELECT 
...
정답
# -- 코드를 작성해주세요
# -- 더 이상 업그레이드할 수 없는 아이템의 ITEM_ID, ITEM_NAME, RARITY 출력
# -- ITEM_ID 기준 내림차순
SELECT
    ITEM_ID,
    ITEM_NAME,
